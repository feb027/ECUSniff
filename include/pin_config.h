...
// ==========================================
// 3. Engine Signal Outputs (Isolated Driver)
// ==========================================
constexpr int8_t SIG_CKP  = 25;  ///< Crankshaft Position Signal (RMT Ch 0)
constexpr int8_t SIG_CMP  = 26;  ///< Camshaft Position Signal 1 (RMT Ch 1)
constexpr int8_t SIG_CMP2 = 18;  ///< Camshaft Position Signal 2 (RMT Ch 2)

// ==========================================
// 4. Engine Signal Inputs (Isolated Capture IN)
// ==========================================
...
constexpr int8_t CAP_CMP2 = 39;  ///< Camshaft Capture Input 2 (VN / Input-only)
