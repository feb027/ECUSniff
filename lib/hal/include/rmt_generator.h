...
private:
    ...
    // Alokasi channel terpisah per 2 block memory
    static constexpr rmt_channel_t CH_CKP  = RMT_CHANNEL_0; // Blocks 0, 1
    static constexpr rmt_channel_t CH_CMP  = RMT_CHANNEL_2; // Blocks 2, 3
    static constexpr rmt_channel_t CH_CMP2 = RMT_CHANNEL_4; // Blocks 4, 5
