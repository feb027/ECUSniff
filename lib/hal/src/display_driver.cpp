...
LGFX_TFT_4_0::LGFX_TFT_4_0() {
    {
        ...
        cfg.spi_3wire   = false;
        cfg.use_lock    = true;
        cfg.dma_channel = 1;                 // Direct DMA channel 1 untuk ESP32-S3
        cfg.pin_sclk = PinConfig::TFT_SCK;   // GPIO 12 (ESP32-S3)
        cfg.pin_mosi = PinConfig::TFT_MOSI;  // GPIO 11 (ESP32-S3)
        cfg.pin_miso = -1;                   // MISO tidak dipakai
        cfg.pin_dc   = PinConfig::TFT_DC;    // GPIO 9 (ESP32-S3)
...

    {
        ...
        cfg.pin_cs           = PinConfig::TFT_CS;   // GPIO 10 (ESP32-S3)
        cfg.pin_rst          = PinConfig::TFT_RST;  // GPIO 14 (ESP32-S3)
        cfg.pin_busy         = -1;
...

    {
        ...
        cfg.pin_bl = PinConfig::TFT_LED;  // GPIO 15 (ESP32-S3)
        cfg.invert = false;
        cfg.freq   = 44100;
        cfg.pwm_channel = 7;
